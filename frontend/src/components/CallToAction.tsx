    ...
    >
      ...
      <div className="w-full max-w-[1400px] mx-auto px-6 md:px-12 relative z-10">
        <div className="relative group rounded-[4rem] overflow-hidden shadow-[0_32px_80px_rgba(0,0,0,0.12)] border border-white/20">
          ...
          <div className="relative z-20 px-8 py-16 md:px-16 md:py-20 flex flex-col xl:flex-row items-center justify-between gap-12 lg:gap-16">
            <div className="flex-1 max-w-[850px] text-center xl:text-left">
              <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-white/5 backdrop-blur-2xl border border-white/10 text-white text-[10px] font-black tracking-[0.2em] uppercase mb-8 shadow-2xl">
                <Sparkles size={16} className="text-[#28a745] animate-bounce" />
                Join the future of rentals
              </div>

              <h2 className="text-4xl md:text-5xl lg:text-5xl xl:text-6xl font-black text-white mb-8 leading-[1.2] tracking-tight">
              ...
              <div className="flex flex-col gap-10">
                <p className="text-lg md:text-xl text-gray-400 font-medium max-w-[600px] leading-relaxed mx-auto xl:mx-0">
            ...
            <div className="flex-shrink-0 flex flex-col items-center gap-6 w-full sm:w-auto mt-12 xl:mt-0">
              <Link
                to="/register"
                className="w-full sm:w-[280px] group relative flex items-center justify-between bg-[#28a745] text-white py-4.5 px-8 rounded-2xl text-xl font-black hover:bg-[#218838] transition-all duration-500 shadow-[0_20px_50px_rgba(40,167,69,0.3)] hover:shadow-[0_25px_60px_rgba(40,167,69,0.4)] active:scale-95 overflow-hidden"
              >
              ...
              <Link
                to="/properties"
                className="w-full sm:w-[280px] flex items-center justify-center gap-3 bg-white/5 backdrop-blur-2xl text-white border border-white/10 py-4.5 px-8 rounded-2xl text-xl font-black hover:bg-white/10 hover:border-white/20 transition-all duration-500 group active:scale-95"
              >
                <Home
                  size={20}
