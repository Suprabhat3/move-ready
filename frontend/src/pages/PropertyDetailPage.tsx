...
export default function PropertyDetailPage({
  ...
  const btnClass =
    "w-full px-6 py-4 rounded-xl border-2 border-black font-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-y-[2px] hover:translate-x-[2px] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] transition-all flex items-center justify-center gap-3 text-lg";
  const pillClass =
    "border-2 border-black rounded-xl px-4 py-2 text-sm font-bold bg-white/40 backdrop-blur-md shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-y-[2px] hover:translate-x-[2px] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] transition-all cursor-default";
            ...
            {listing.images.length > 1 ? (
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-4">
                {listing.images.slice(1, 4).map((image, i) => (
                  <div
                    key={image.url}
                    className={`${i === 2 ? "hidden md:block" : ""} rounded-2xl overflow-hidden border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] transition-all cursor-pointer`}
                  >
                    <img
                      src={image.url}
          ...
          <div className="bg-white/60 backdrop-blur-xl border-2 border-black/20 p-6 md:p-8 rounded-[2rem] shadow-[8px_8px_0px_0px_rgba(0,0,0,0.8)] space-y-10">
            ...
            <div className="flex flex-col xl:flex-row items-start justify-between gap-6 pb-8 border-b-2 border-black/10">
              ...
              <div className="bg-black/90 backdrop-blur-md text-white border-2 border-black rounded-2xl px-8 py-6 shadow-[8px_8px_0px_0px_rgba(0,229,255,1)] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[4px_4px_0px_0px_rgba(0,229,255,1)] transition-all shrink-0">
                <p className="text-sm font-black text-[#00e5ff] uppercase tracking-widest mb-1">
                  Rent Amount
                </p>
                <p className="text-4xl md:text-5xl font-black">
                  ₹{listing.rentAmount.toLocaleString()}
                </p>
                <p className="text-sm font-bold opacity-80 mt-1 flex justify-end">
                  per month
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="border-2 border-black rounded-2xl p-5 bg-white/40 backdrop-blur-md shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] flex flex-col items-center text-center">
                ...
                <p className="text-xs uppercase font-black text-black/60">
                  Bedrooms
                </p>
              ...
              <div className="border-2 border-black rounded-2xl p-5 bg-black text-white shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] flex flex-col items-center text-center">
                ...
                <p className="text-xs uppercase font-black text-white/60">
                  Available
                </p>
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              <div className="space-y-4">
                <h2 className="text-xl font-black uppercase tracking-wide border-b-2 border-black/10 pb-2">
                  Home Details
                </h2>
              ...
              <div className="space-y-4">
                ...
                <div className="grid gap-3">
                  ...
                  <div className="flex justify-between items-center p-3 bg-white/40 rounded-xl border-2 border-black/10">
                    <span className="font-black text-black/60 flex items-center gap-1">
            ...
            <div className="pt-6 border-t-2 border-black/10">
              ...
              <div className="flex flex-wrap gap-3">
                {listing.amenities.map((amenity) => (
                  <span
                    key={amenity}
                    className={`${pillClass} border-black text-black hover:bg-[#00e5ff]`}
                  >
                    {amenity}
                  </span>
                ))}
              ...
              <div>
                ...
                <ul className="space-y-3">
                  {listing.rules.map((rule) => (
                    <li
                      key={rule}
                      className="flex items-start gap-2 font-bold text-black/80"
                    >
            ...
            <div className="space-y-5">
              ...
              {user?.role === "TENANT" && (
                <button
                  ...
                  className={`${btnClass} bg-yellow-400 text-black disabled:opacity-50`}
                >
              ...
              >
                <Heart
                  className={`h-6 w-6 ${listing.shortlisted ? "fill-current" : ""}`}
                />
